...
import { DDCrepo_url } from './config/rest_config/';

class DzongkhaDevelopmentCommision extends Component {
    ...
    componentDidMount() {
        this.getDetails(`${DDCrepo_url}`, 'repo');//repo Details
        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.Topheader}>
                    ...
                    <Text style={styles.headerText}>Dzongkha Development Commision</Text>
                </View>
                <Animatable.View
...
export default DzongkhaDevelopmentCommision;
