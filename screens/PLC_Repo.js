...
import { PLCrepo_url } from './config/rest_config/';
...
class Repository extends Component {
    ...
    //     const path = '/Home/Nfe system user manual (Namgay).docx'
    ...
    componentDidMount() {
        this.getDetails(`${PLCrepo_url}`, 'repo');//repo Details
            ...
            .then(responseJson => {
                ...
                if (targetstate == "repo") {
                    this.setState({
                        ...
                        download: responseJson[0].downloads.toString(),
        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.Topheader}>
                    ...
                    <Text style={styles.headerText}>PLC Reading Marerials</Text>
                        ...
                        <Content padder>
                            <Card>
                                ...
                                <CardItem bordered>
                                    <Body>
                                        <TextInput style={{ color: "#111",fontSize: 15 }}
                                            value={this.state.download} editable={false}
                                        />
                                    </Body>
                                </CardItem>
                                ...
                                <CardItem footer bordered>
                                    <TouchableOpacity style={styles.btn2} onPress={() => this.downloads()}>
                                        <Text style={styles.btnText}>Download</Text></TouchableOpacity>
