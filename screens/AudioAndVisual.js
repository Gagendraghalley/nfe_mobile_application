...
import { AVMrepo_url } from './config/rest_config/';

class AudioAndVisual extends Component {
    ...
    componentDidMount() {
        this.getDetails(`${AVMrepo_url}`, 'repo');//repo Details
        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.Topheader}>
                    ...
                    <Text style={styles.headerText}>Audio And Visual</Text>
                </View>
                <Animatable.View
