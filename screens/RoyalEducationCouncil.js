...
import { RECrepo_url } from './config/rest_config/';

class RoyalEducationCouncil extends Component {
    ...
    componentDidMount() {
        this.getDetails(`${RECrepo_url}`, 'repo');//repo Details
        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.Topheader}>
                    ...
                    <Text style={styles.headerText}>Royal Education Council</Text>
                </View>
                <Animatable.View
...
export default RoyalEducationCouncil;
