...
import { SRrepo_url } from './config/rest_config/';

class SupplymentryReading extends Component {
    ...
    componentDidMount() {
        this.getDetails(`${SRrepo_url}`, 'repo');//repo Details
        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.Topheader}>
                    ...
                    <Text style={styles.headerText}>Supplimentary Reading Marerials</Text>
                </View>
                <Animatable.View
...
export default SupplymentryReading;
