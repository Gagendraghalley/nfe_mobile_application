...
import { centrecount_url } from './config/rest_config/';
...
export default class NfeCenter extends Component {
  ...
  async componentDidMount() {
    this.getDetails(`${centrecount_url}`, 'centrecount');//centre count
    ...
    return (
      ...
      <View style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerText}> Total Instructors in Bhutan</Text>
        </View>
        <Animatable.View
        ...
        >
          <ScrollView>
            ...
            <Fieldset>
              <Text style={styles.action} >Total Number of BLC Instructor:</Text>
              ...
              />
              <Text style={styles.action} >Total Number of PLC Instructor:</Text>
              <TextInput type style={styles.placeholder1}
                value={this.state.count}
                placeholder="10"
                editable={false}
              ...
              <Text style={styles.action} >Total Number of ALC Instructor: </Text>
              <TextInput type style={styles.placeholder1}
                value={this.state.count}
                placeholder="9"
                editable={false}
