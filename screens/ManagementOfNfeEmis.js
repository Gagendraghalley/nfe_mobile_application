...
class ManagementOfNfeEmis extends Component {
  ...
  //To pull Monitoring types
  // componentDidMount() {
  //   this.getDetails('http://10.0.2.2:8009/api/dzongkhags/1', 'MonitoringType');//Monitoring
  //   this.getDetails('http://10.0.2.2:8009/api/dzongkhags/1', 'Dzongkhag');//Dzongkhag
  //   this.getDetails('http://10.0.2.2:8009/api/dzongkhags/1', 'school');//schhool
  ...
  //     .then(responseJson => {
  //       //Monitoring Tools
  //       if (targetstate == "MonitoringType") {
  //         this.setState({
  //           MonitoringType: responseJson.data.MonitoringType,
  //         });
  //       }
  //       //Monitoring Tools
  //       if (targetstate == "Dzongkhag") {
  //         this.setState({
  //           Dzongkhag: responseJson.data.Dzongkhag,
  //         });
  //       }
  ...
  //         this.setState({
  //           school: responseJson.data.school,
  //         });
  //       }
  //     })
  // }
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerText}>Management of NFE-EMIS</Text>
        </View>
        <Animatable.View
        ...
        >
          <ScrollView>
            <Fieldset>
              <Text style={styles.action}>1. Classroom and equipment setting:*</Text>
              ...
              <Text >  </Text>
              <Text style={styles.action}>2. Teaching methods (Andragogy and others):*</Text>
              <View style={styles.RadioButton}>
                <RadioGroup
                  color='#0277BD'
                  labelStyle={{ fontSize: 14, }}
...
export default ManagementOfNfeEmis;
